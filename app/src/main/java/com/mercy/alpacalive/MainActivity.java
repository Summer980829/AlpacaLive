...
//                            Validate id or password
                            ...
                            if(success.equals("1")){
                                ...
                                for(int i = 0; i < jsonArray.length(); i++){
                                    ...
                                    Intent intent = new Intent(MainActivity.this, EventListing.class);
                                    startActivity(intent);
                                }
                            } else {
                                if(message.equals("wrongpass")) {
                                    Toast.makeText(MainActivity.this, "Failed to login. Incorrect password.", Toast.LENGTH_SHORT).show();
                                } else {
